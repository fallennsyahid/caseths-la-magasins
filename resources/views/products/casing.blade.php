...
<body>
    <x-navbar></x-navbar> {{-- Hero Section Start --}}
            ...
            @foreach ($products as $product)
                <div class="product-card">
                    <a class="product-image-wrapper" href="#">
                        <img class="product-image" src="{{ asset('storage/' . $product->picture) }}"
                            alt="{{ $product->product }}" />
                    </a>
                    <div class="product-details">
                        ...
                        <div class="product-pricing">
                            <p>
                                ...
                                <span
                                    class="product-original-price opacity-0 cursor-default">{{ number_format($product->price, 2) }}</span>
                            </p>
                        </div>
                        {{-- @if (Auth::check())
